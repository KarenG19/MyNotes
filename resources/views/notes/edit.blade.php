...
>
    ...
    <h1 class="my-4 py-6 font-serif text-3xl text-center text-sky-600 dark:text-sky-500">Update Note</h1>

    <form class="max-w-xl px-8 py-4 mx-auto bg-white rounded shadow dark:bg-slate-800" action="{{ route('notes.update', $note) }}" method="POST">
        @csrf @method('PATCH')
        ...
        <div class="flex flex-col items-center justify-center my-2 mx-auto">
            ...
            <a class="py-2 font-serif text-sky-600 dark:text-sky-500 focus:border-slate-500" href="{{ route('notes.show', $note) }}">Back</a>
        </div>
    </form>
