...
>
    ...
    <div class="py-16 flex flex-col justify-center items-center">
        <h1 class="my-4 font-serif text-3xl text-sky-600 dark:text-sky-500">
            Welcome to MyNotes
        </h1>

        <svg class="svg-icon my-4" 
            style="width: 15em; height: 15em;vertical-align: middle;fill: currentColor;overflow: hidden;" 
