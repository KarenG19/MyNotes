    ...
    <div class="flex justify-center items-center py-16">
        <form class="max-w-xl px-8 py-6 mx-auto bg-white rounded shadow dark:bg-slate-800" action="{{ route('login') }}" method="POST">
            ...
            <div class="flex flex-col items-center">
                ...
                <h1 class="my-4 font-serif text-3xl text-sky-600 dark:text-sky-500">MyNotes</h1>
            </div>
            ...
            <div class="flex flex-col items-center mt-6">
                ...
                <p class="p-4 font-serif text-slate-600 dark:text-slate-400">
                    ...
                    <a class="font-serif border-2 border-transparent rounded text-sky-600 dark:text-sky-500 focus:border-slate-500 focus:outline-none" href="{{ route('register') }}">Register</a>
                </p>
            </div>
